...
If you want to add a feature, please file an [Issue](https://github.com/dfed/swift-concurrent-sequence/issues) first. An Issue gives us the opportunity to discuss the requirements and implications of a feature with you before you start writing code.
